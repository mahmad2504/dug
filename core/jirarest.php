		...
		switch($field)
		{
			...
			case 'issuelinks':
				...
				foreach($data['fields']['issuelinks'] as $issuelink)
				{
					...
					{
						//echo 'Blocks '.$issuelink['inwardIssue']['key'].EOL;
						$issuelinks[DEPENDENCY_BLOCKS][] = $issuelink['inwardIssue']['key'];
					}
					if(isset($issuelink['outwardIssue']))
					{
						//echo 'Depends '.$issuelink['outwardIssue']['key'].EOL;
						$issuelinks[DEPENDENCY_DEPENDS][] = $issuelink['outwardIssue']['key'];
					}
					//$issuelinks[] =  $issuelink['inwardIssue']['key'];
					//$issuelinks[] =  $issuelink['outwardIssue']['key'];
				}
